...
import kotlinx.android.synthetic.main.activity_mitra_1.*
import kotlinx.android.synthetic.main.activity_mitra_2.*
import java.text.SimpleDateFormat
import java.util.*

class Mitra_2 : AppCompatActivity() {
    ...
    val iso     = "${mti}201A401000000000${code}${time}${date}${year}0002"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mitra_2)
        ...
        tv  = findViewById(R.id.tvscan2)
        btn = findViewById(R.id.bscan2)
        ...
        if(resultCode == Activity.RESULT_OK){
            ...
            if(result != null){
                if (result.contents == null){
                    ...
                    val code = ("1002").toInt()
                    val hasil4 = tvscan2.text.toString().replace("Rp ", "")
                    ...
                    if (hasil3 == code) {
                        ...
                        if(hasil5 < 0){
                            val builder = AlertDialog.Builder(this@Mitra_2)
                      ...
                      builder.setMessage("Apakah anda ingin membayar ${rp} kepada mitra Mitra2")
                              ...
                              override fun onDataChange(p0: DataSnapshot)  {
                                  ...
                                  it.forEach{
                                      ...
                                      if(panjang == 1)
                                      {
                                          ...
                                          db.inserData4("Mitra2", "${hasil02}", "${date_2}", "${time_2}")
                                          tampil()
                                      }
                    ...
                    else
                    {
                        val builder = AlertDialog.Builder(this@Mitra_2)
                        builder.setTitle("Transaksi Gagal")
                        builder.setMessage("QR Code yang anda scan bukan dari mitra Mitra2")
                        builder.setNeutralButton("Kembali"){_,_ ->
                            Toast.makeText(applicationContext,"Transaksi dibatalkan", Toast.LENGTH_SHORT).show()
                        }
