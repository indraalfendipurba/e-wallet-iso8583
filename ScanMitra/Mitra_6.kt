...
import kotlinx.android.synthetic.main.activity_mitra_6.*
import java.text.SimpleDateFormat
import java.util.*

class Mitra_6 : AppCompatActivity() {
    ...
    val iso     = "${mti}201A401000000000${code}${time}${date}${year}0006"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mitra_6)
        ...
        tv  = findViewById(R.id.tvscan6)
        btn = findViewById(R.id.bscan6)
        ...
        if(resultCode == Activity.RESULT_OK){
            ...
            if(result != null){
                if (result.contents == null){
                    ...
                    val code = ("1006").toInt()
                    val hasil4 = tvscan6.text.toString().replace("Rp ", "")
                    val hasil5 = hasil4.toInt() - hasil02.toInt()

                    if (hasil3 == code) {

                        if(hasil5 < 0){
                            val builder = AlertDialog.Builder(this@Mitra_6)
                            ...
                            builder.setMessage("Apakah anda ingin membayar ${rp} kepada mitra Mitra6")
                                    ...
                                    override fun onDataChange(p0: DataSnapshot)  {
                                        ...
                                        it.forEach{
                                            ...
                                            if(panjang == 1)
                                            {
                                                ...
                                                db.inserData4("Mitra6", "${hasil02}", "${date_2}", "${time_2}")
                                                tampil()
                                            }
                    ...
                    else
                    {
                        val builder = AlertDialog.Builder(this@Mitra_6)
                        builder.setTitle("Transaksi Gagal")
                        builder.setMessage("QR Code yang anda scan bukan dari mitra Mitra6")
                        builder.setNeutralButton("Kembali"){_,_ ->
                            Toast.makeText(applicationContext,"Transaksi dibatalkan", Toast.LENGTH_SHORT).show()
                        }
