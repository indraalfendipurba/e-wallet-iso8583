...
import kotlinx.android.synthetic.main.activity_mitra_10.*
import kotlinx.android.synthetic.main.activity_mitra_2.*
import kotlinx.android.synthetic.main.activity_mitra_9.*
import java.text.SimpleDateFormat
import java.util.*

class Mitra_10 : AppCompatActivity() {
    ...
    val iso     = "${mti}201A401000000000${code}${time}${date}${year}0010"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mitra_10)
        ...
        tv  = findViewById(R.id.tvscan10)
        btn = findViewById(R.id.bscan10)
        ...
        if(resultCode == Activity.RESULT_OK){
            ...
            if(result != null){
                if (result.contents == null){
                    ...
                    val code = ("1010").toInt()
                    val hasil4 = tvscan10.text.toString().replace("Rp ", "")
                    ...
                    if (hasil3 == code) {
                        ...
                        if(hasil5 < 0){
                            val builder = AlertDialog.Builder(this@Mitra_10)
                            ...
                            builder.setMessage("Apakah anda ingin membayar ${rp} kepada mitra Mitra10")
                                    ...
                                    override fun onDataChange(p0: DataSnapshot)  {
                                        ...
                                        it.forEach{
                                            ...
                                            if(panjang == 1)
                                            {
                                                ...
                                                db.inserData4("Mitra10", "${hasil02}", "${date_2}", "${time_2}")
                                                tampil()
                                            }
                    ...
                    else
                    {
                        val builder = AlertDialog.Builder(this@Mitra_10)
                        builder.setTitle("Transaksi Gagal")
                        builder.setMessage("QR Code yang anda scan bukan dari mitra Mitra10")
                        builder.setNeutralButton("Kembali"){_,_ ->
                            Toast.makeText(applicationContext,"Transaksi dibatalkan", Toast.LENGTH_SHORT).show()
                        }
    ...
    private fun tampil(){
        ...
        onBackPressed()
        //startActivity(Intent(this, LayarMitra::class.java)):class.java))
