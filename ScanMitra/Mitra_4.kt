...
import kotlinx.android.synthetic.main.activity_mitra_4.*
import java.text.SimpleDateFormat
import java.util.*

class Mitra_4 : AppCompatActivity() {
    ...
    val iso     = "${mti}201A401000000000${code}${time}${date}${year}0004"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mitra_4)
        ...
        tv  = findViewById(R.id.tvscan4)
        btn = findViewById(R.id.bscan4)
        ...
        if(resultCode == Activity.RESULT_OK){
            ...
            if(result != null){
                if (result.contents == null){
                    ...
                    val code = ("1004").toInt()
                    val hasil4 = tvscan4.text.toString().replace("Rp ", "")
                    val hasil5 = hasil4.toInt() - hasil02.toInt()

                    if (hasil3 == code) {
                        if(hasil5 < 0){
                            val builder = AlertDialog.Builder(this@Mitra_4)
                            ...
                            builder.setMessage("Apakah anda ingin membayar ${rp} kepada mitra Mitra4")
                                    ...
                                    override fun onDataChange(p0: DataSnapshot)  {
                                        ...
                                        it.forEach{
                                            ...
                                            if(panjang == 1)
                                            {
                                                ...
                                                db.inserData4("Mitra4", "${hasil02}", "${date_2}", "${time_2}")
                                                tampil()
                                            }
                    ...
                    else
                    {
                        val builder = AlertDialog.Builder(this@Mitra_4)
                        builder.setTitle("Transaksi Gagal")
                        builder.setMessage("QR Code yang anda scan bukan dari mitra Mitra4 CINEMAS")
                        builder.setNeutralButton("Kembali"){_,_ ->
                            Toast.makeText(applicationContext,"Transaksi dibatalkan", Toast.LENGTH_SHORT).show()
                        }
