...
import kotlinx.android.synthetic.main.activity_mitra_7.*
import java.text.SimpleDateFormat
import java.util.*

class Mitra_7 : AppCompatActivity() {
    ...
    val iso     = "${mti}201A401000000000${code}${time}${date}${year}0007"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mitra_7)
        ...
        tv  = findViewById(R.id.tvscan7)
        btn = findViewById(R.id.bscan7)
        ...
        if(resultCode == Activity.RESULT_OK){
            ...
            if(result != null){
                if (result.contents == null){
                    ...
                    val code = ("1007").toInt()
                    val hasil4 = tvscan7.text.toString().replace("Rp ", "")
                    val hasil5 = hasil4.toInt() - hasil02.toInt()

                    if (hasil3 == code) {

                        if(hasil5 < 0){
                            val builder = AlertDialog.Builder(this@Mitra_7)
                            ...
                            builder.setMessage("Apakah anda ingin membayar ${rp} kepada mitra Mitra7")
                                    ...
                                    override fun onDataChange(p0: DataSnapshot)  {
                                        ...
                                        it.forEach{
                                            ...
                                            if(panjang == 1)
                                            {
                                                ...
                                                db.inserData4("Mitra7", "${hasil02}", "${date_2}", "${time_2}")
                                                tampil()
                                            }
                    ...
                    else
                    {
                        val builder = AlertDialog.Builder(this@Mitra_7)
                        builder.setTitle("Transaksi Gagal")
                        builder.setMessage("QR Code yang anda scan bukan dari mitra Mitra7")
                        builder.setNeutralButton("Kembali"){_,_ ->
                            Toast.makeText(applicationContext,"Transaksi dibatalkan", Toast.LENGTH_SHORT).show()
                        }
